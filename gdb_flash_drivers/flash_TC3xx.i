...
#define HF_ECCC 0xF8040048u
#define HF_ECCS 0xF8040044u
  ...
  if ((*((volatile unsigned int *)(&parameter[4]))) == 1)
    {
      ...
      if (burst==0x0) { (*((volatile unsigned int *)(&parameter[4]))) = 0x100;__asm ("	debug"); }
      while (parameter[3] > 0)
 {
   for (i=0; i<burst; i++)
     {
   ...
   for (timeout=0x4000; timeout>0; timeout--)
     {
       ...
       if (timeout==1) {
    parameter[2] = addr_aligned; (*((volatile unsigned int *)(&parameter[4]))) = 0x0100; (*((volatile unsigned int *)(0xAF005554))) = 0xFA; __asm ("	debug");
       }
     }
   addr_aligned+=burst*4;
 }
      if (((*((volatile unsigned int *)(0xF8040034u))) & 0x003E)!=0)
 (*((volatile unsigned int *)(&parameter[4]))) = 0x0100; else (*((volatile unsigned int *)(&parameter[4])))=0x0;
  ...
  if ((*((volatile unsigned int *)(&parameter[4]))) == 2)
    {
      ...
      __asm ("	dsync");
      (*((volatile unsigned int *)(0xAF00AA58))) = parameter[3];
      __asm ("	dsync");
...
# 178 "flash_TC3xx.c"
      ...
      while (data[0]!=0xFFFFFFFF)
 {
   ...
   if (data[5]!=0)
     {
       (*((volatile unsigned int *)(data[5]+0x1104u)))=0x02010000;
       __asm ("	dsync");
       (*((volatile unsigned int *)(data[5]+0x1108u)))=0x55010A05;
       __asm ("	dsync");
     }
   else
     {

       (*((volatile unsigned int *)(0xF8040048u)))=0xF0000000;
       __asm ("	dsync");
       ...
       while (ii<len_verify)
  {
   ...
   if (data[5]!=0)
     {
       tmp1=(*((volatile unsigned int *)(data[4]+0x20u)));
       if ((tmp1 & ~0x80008)!=0) data[3]=0xEEEEEEEE;
       (*((volatile unsigned int *)(data[5]+0x1104u)))=0x02020000;
       __asm ("	dsync");
       (*((volatile unsigned int *)(data[5]+0x1108u)))=0x55010A05;
       __asm ("	dsync");
       (*((volatile unsigned int *)(data[5]+0x1108u)))=0x55020A05;
       __asm ("	dsync");
       tmp2=(*((volatile unsigned int *)(data[4]+0x20u)));
       data[6]=tmp1;
       data[7]=tmp2;
     }
   else
     {
       tmp1=(*((volatile unsigned int *)(0xF8040044u)));
       if ((tmp1 & ~0x80008)!=0) data[3]=0xEEEEEEEE;
       (*((volatile unsigned int *)(0xF8040048u)))=0xF0000000;
       __asm ("	dsync");
       (*((volatile unsigned int *)(0xF8040048u)))=0xC0000000;
       __asm ("	dsync");
       tmp2=(*((volatile unsigned int *)(0xF8040044u)));
       data[6]=tmp1;
       data[7]=tmp2;
     }
   data+=8;
